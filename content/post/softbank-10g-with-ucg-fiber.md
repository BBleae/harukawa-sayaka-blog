...
![UCG-Fiber 实物照片 — 紧凑的桌面型 10G 网关，正面可见 SFP+ 和 RJ45 端口](placeholder-ucg-fiber-photo.png)
...
![UniFi Dashboard 截图 — WAN 状态显示为 UP (绿色)，hook 生效后健康检测通过 tun4 正常工作](placeholder-unifi-wan-up.png)
